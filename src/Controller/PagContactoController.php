...
class PagContactoController extends AbstractController
{
     ...
     */
    public function index(PagContactoRepository $pagContactoRepository): Response
    {
     ...
     */
    public function show(PagContacto $pagContacto): Response
    {
     ...
     */
    public function edit(Request $request, PagContacto $pagContacto): Response
    {
        $form = $this->createForm(PagContactoType::class, $pagContacto);
        $form->handleRequest($request);
